...
public class ClientController {
    ...
    public void runApp() {
        ...
        double paymentInitial = model.calcPayment(model.getQuantity(), model.getPrice());
        String paymentInitialRounded = Rounder.roundValue(paymentInitial);

        double discount = model.calcDiscount(paymentInitial);
        String discountRounded = Rounder.roundValue(discount);

        String paymentRounded = Rounder.roundValue(model.calcPayment(paymentInitial, discount));
